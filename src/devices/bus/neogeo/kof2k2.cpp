...
DEFINE_DEVICE_TYPE(NEOGEO_K2K2_KOF2002D_CART, neogeo_kof2002d_cart_device, "neocart_kof2002d", "Neo Geo KoF 2002 Decrypted Cart")
...
neogeo_kof2002d_cart_device::neogeo_kof2002d_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock) :
	neogeo_kof2k2type_cart_device(mconfig, NEOGEO_K2K2_KOF2002D_CART, tag, owner, clock)
{
}
...
DEFINE_DEVICE_TYPE(NEOGEO_K2K2_KF2K2PLSD_CART, neogeo_kf2k2plsd_cart_device, "neocart_kf2k2plsd", "Neo Geo KoF 2002 Plus Decrypted Cart")
...
neogeo_kf2k2plsd_cart_device::neogeo_kf2k2plsd_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock) :
	neogeo_kof2k2type_cart_device(mconfig, NEOGEO_K2K2_KF2K2PLSD_CART, tag, owner, clock)
{
}
...
DEFINE_DEVICE_TYPE(NEOGEO_K2K2_MATRIMD_CART, neogeo_matrimd_cart_device, "neocart_matrimd", "Neo Geo Matrimelee Decrypted Cart")
...
neogeo_matrimd_cart_device::neogeo_matrimd_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock) :
	neogeo_kof2k2type_cart_device(mconfig, NEOGEO_K2K2_MATRIMD_CART, tag, owner, clock)
{
}
...
DEFINE_DEVICE_TYPE(NEOGEO_K2K2_SAMSHO5D_CART, neogeo_samsho5d_cart_device, "neocart_samsho5d", "Neo Geo Samurai Shodown 5 Decrypted Cart")
...
neogeo_samsho5d_cart_device::neogeo_samsho5d_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock) :
	neogeo_kof2k2type_cart_device(mconfig, NEOGEO_K2K2_SAMSHO5D_CART, tag, owner, clock)
{
}
...
DEFINE_DEVICE_TYPE(NEOGEO_K2K2_SAMSHO5SPD_CART, neogeo_samsho5spd_cart_device, "neocart_samsh5spd", "Neo Geo Samurai Shodown 5 Special Decrypted Cart")
...
neogeo_samsho5spd_cart_device::neogeo_samsho5spd_cart_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock) :
	neogeo_kof2k2type_cart_device(mconfig, NEOGEO_K2K2_SAMSHO5SPD_CART, tag, owner, clock)
{
}
