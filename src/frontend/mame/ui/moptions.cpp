...
const options_entry ui_options::s_option_entries[] =
{
	...
	{ OPTION_SKIP_BIOS_MENU,                "1",        option_type::BOOLEAN,     "skip bios submenu, start with configured or default" }, // 修改的 (加斯顿90)
	...
	{ OPTION_FORCED4X3,                     "0",        option_type::BOOLEAN,     "force 4:3 aspect ratio for snapshots in the software menu" }, // 修改的 (加斯顿90)
