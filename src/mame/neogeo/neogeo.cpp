...
// 修改的 (Gaston90) 
/****************************************************/
	// fixed software configurations (Decrypted)
...
{
	mv1_fixed(config);
	cartslot_fixed(config, "decrypt_cthd2k3a");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}
...
{
	mv1_fixed(config);
	cartslot_fixed(config, "decrypt_kf10thu");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}
...
{
	mv1_fixed(config);
	cartslot_fixed(config, "decrypt_kf2k2mpd");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}
...
{
	mv1_fixed(config);
	cartslot_fixed(config, "decrypt_kf2k2mp2d");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}
...
{
	mv1_fixed(config);
	cartslot_fixed(config, "decrypt_kf2k2pd");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}
...
{
	mv1_fixed(config);
	cartslot_fixed(config, "decrypt_kof2k4pls");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}
...
{
	mv1_fixed(config);
	cartslot_fixed(config, "decrypt_kof96ep");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}
...
{
	mv1_fixed(config);
	cartslot_fixed(config, "decrypt_kof2k2d");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}
...
{
	mv1_fixed(config);
	cartslot_fixed(config, "decrypt_kf2k3d");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}
...
{
	mv1_fixed(config);
	cartslot_fixed(config, "decrypt_kf2k3hd");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}
...
{
	mv1_fixed(config);
	cartslot_fixed(config, "decrypt_matrimd");
}
...
{
	mv1_fixed(config);
	cartslot_fixed(config, "decrypt_mslug5d");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}
...
{
	mv1_fixed(config);
	cartslot_fixed(config, "decrypt_mslug5e");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}
...
{
	mv1_fixed(config);
	cartslot_fixed(config, "decrypt_samsh5d");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}
...
{
	mv1_fixed(config);
	cartslot_fixed(config, "decrypt_sams5sd");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}
...
{
	mv1_fixed(config);
	cartslot_fixed(config, "decrypt_svcd");
	m_screen->set_visarea(NEOGEO_HBEND+8, NEOGEO_HBSTART-8-1, NEOGEO_VBEND, NEOGEO_VBSTART-1);
}
...
ROM_START( bangbedd )
	...
	NEO_SFIX_128K( "259d.s1", CRC(bb50fb2d) SHA1(7372939f328fb5e7d09c16985e09ae8c34702b0c) )
...
ROM_START( cthd2k3a )
	...
	ROM_LOAD16_BYTE( "5003.c3", 0x1000000, 0x800000, CRC(ac4aff71) SHA1(c983f642e68deaa40fee3e208f2dd55f3bacbdc1) )
	ROM_LOAD16_BYTE( "5003.c4", 0x1000001, 0x800000, CRC(afef5d66) SHA1(39fe785563fbea54bba88de60dcc62e2458bd74a) )
	ROM_LOAD16_BYTE( "5003.c5", 0x2000000, 0x800000, CRC(c7c1ae50) SHA1(f54f5be7513a5ce2f01ab107a2b26f6a9ee1f2a9) )
	ROM_LOAD16_BYTE( "5003.c6", 0x2000001, 0x800000, CRC(613197f9) SHA1(6d1fefa1be81b79e251e55a1352544c0298e4674) )
...
ROM_START( ct2k3spd )
	ROM_REGION( 0x500000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "5003sa.p1", 0x000000, 0x100000, CRC(013a509d) SHA1(c61c9b777e6e062b5f4ad87cdb78e9ca05e9bfb9) )
	ROM_LOAD16_WORD_SWAP( "360d.p2", 0x100000, 0x400000, CRC(eba65bda) SHA1(e66755cb11e8b16f1af68c1439dd0ec485573c10) )
...
ROM_START( kof97orond )
	ROM_REGION( 0x500000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "232ond.p1", 0x000000, 0x100000, CRC(035911c5) SHA1(3321862384ec91174f1822cfdbc2bf1d1407e775) )
	ROM_LOAD16_WORD_SWAP( "232-p2.sp2", 0x100000, 0x400000, CRC(158b23f6) SHA1(9744620a70513490aaf9c5eda33e5ec31222be19) )

	NEO_SFIX_128K( "232ond.s1", CRC(cf6afb00) SHA1(aca3d9f571af3195a96bf044f353b3f0bc4cfc3a) )
...
ROM_START( kf2k2plsd )
	...
	NEO_SFIX_128K( "265pla.s1", CRC(595e0006) SHA1(ff086bdaa6f40e9ad963e1100a27f44618d684ed) )
...
ROM_START( kf2k2plbd )
	ROM_REGION( 0x500000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "265plb.p1", 0x000000, 0x100000, CRC(3ab03781) SHA1(86946c19f1c4d9ab5cde86688d698bf63118a39d) )
	ROM_LOAD16_WORD_SWAP( "265-p2.sp2",  0x100000, 0x400000, CRC(327266b8) SHA1(98f445cc0a94f8744d74bca71cb420277622b034) )
...
ROM_START( kf2k2pldd )
	ROM_REGION( 0x500000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "265pld.p1", 0x000000, 0x100000, CRC(ea1b6e9c) SHA1(cd03c205eb775f133d1f13b1524aac17ec1a6ce3) )
	ROM_LOAD16_WORD_SWAP( "265-p2.sp2",  0x100000, 0x400000, CRC(327266b8) SHA1(98f445cc0a94f8744d74bca71cb420277622b034) )

	NEO_SFIX_128K( "265pld.s1", CRC(7df52924) SHA1(4b89eb6a2eeeccf5aef40b0775d61970ea9de60c) )
...
ROM_START( kf2k2mpnd )
	ROM_REGION( 0x500000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "265mpp.p1", 0x000000, 0x100000, CRC(4da7a8f6) SHA1(5efe22dfc2a1cbaaa479d06199d818e3af81fc67) )
	ROM_LOAD16_WORD_SWAP( "k2k2m2p2.bin", 0x100000, 0x400000, CRC(432fdf53) SHA1(d7e542cd84d948162c60768e40ee4ed33d8e7913) )

	NEO_SFIX_128K( "265mpl.s1", CRC(29c0693e) SHA1(a852d15a8558b4a1cadf1ed9ef357d765ff88d35) )
...
ROM_START( kf2k2mp2nd )
	ROM_REGION( 0x600000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "265mp2nd.p1", 0x000000, 0x100000, CRC(f8c7efd7) SHA1(39f249405d3b0993748773ca54cbe50d1a191c79) )
	ROM_LOAD16_WORD_SWAP( "k2k2m2p2.bin", 0x100000, 0x400000, CRC(432fdf53) SHA1(d7e542cd84d948162c60768e40ee4ed33d8e7913) )

	NEO_SFIX_128K( "265mp2nd.s1", CRC(df4ce33b) SHA1(1287c84c16e17df7d5887af57fc6657da452d0ae) )
...
ROM_START( kf2k3bd )
	...
	NEO_SFIX_128K( "271p.s1", CRC(c47f8ac3) SHA1(502070fa57e59d36e5e544e1e2836fefa18a5743) )

	NEO_BIOS_AUDIO_128K( "271bl.m1", CRC(3a4969ff) SHA1(2fc107a023a82053a8df63025829bcf12cee9610) )
...
ROM_START( kof2k3hd )
	...
	NEO_SFIX_512K( "271hd.s1", CRC(1d4ecb1e) SHA1(115101010fe739e6a684498ba5e6e468b62181b9) )
...
ROM_START( kof2k3nd )
	...
	NEO_SFIX_128K( "271pcd.s1", CRC(df422440) SHA1(ed84dfd6cc5a73f3ef35db6616bcc3b45754aa4d) )
...
ROM_START( kf2k3pd )
    ...
    NEO_SFIX_512K( "364pd.s1", CRC(71b538cf) SHA1(d230aa4bd6eb24a08faebfc948a62c4b31d84b41) )
...
ROM_START( kf2k3upd )
	ROM_REGION( 0x800000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "271upd.p1", 0x000000, 0x800000, CRC(4793b724) SHA1(e49b8496c55bdcf12a8bf0e65f249c68339cc568) )

	NEO_SFIX_512K( "364upd.s1", CRC(3df88da7) SHA1(50ad48ef1e57bbf522d9e6c0c9e7f88c4a96d1f9) )
...
ROM_START( kof10thu )
	ROM_REGION( 0x800000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "363thu.p1", 0x600000, 0x100000, CRC(dd135fb6) SHA1(4e85814a44ee9fee9760048dd6d6fd2b66521bb1) )
	ROM_CONTINUE( 0x100000, 0x500000 )
	ROM_CONTINUE( 0x000000, 0x100000 )
	ROM_CONTINUE( 0x700000, 0x100000 )

    NEO_SFIX_128K( "363thu.s1", CRC(b22ba74f) SHA1(3ba9e9d4b95fef9bf35f76e9d4fb6e1a36aeee5a) )
...
ROM_START( matrimbd )
	...
	ROM_REGION( 0x1000000, "cslot1:ymsnd:adpcma", 0 )
	ROM_LOAD( "266b.v1", 0x000000, 0x400000, CRC(352b0a07) SHA1(19f7cc12f3f6d0fda9c7449816c4c32367447897) )
	ROM_LOAD( "266a.v2", 0x400000, 0x400000, CRC(945f8831) SHA1(6ac9bd41e0bb33601c82ebeb2aa5b1b8b91fada1) )
	ROM_LOAD( "266b.v3", 0x800000, 0x400000, CRC(e8362fcc) SHA1(42d558fd80cabe22a1c09a1fa75741afbcf46b7c) )
...
ROM_START( matrimnd )
	...
	NEO_BIOS_AUDIO_128K( "266nd.m1", CRC(f692d84b) SHA1(a3737c574e779e0330916a2eea6ad5b3839f9538) )
...
ROM_START( ms5plusd )
	ROM_REGION( 0x500000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "268pd.p1", 0x000000, 0x100000, CRC(76af334f) SHA1(cbd890a9c14d42acd1923bb5074fb560a306cce3) )
	ROM_LOAD16_WORD_SWAP( "268p.p2",  0x100000, 0x200000, CRC(d6a458e8) SHA1(c0a8bdae06d62859fb6734766ccc190eb2a809a4) )
	ROM_LOAD16_WORD_SWAP( "268p.p3",  0x300000, 0x200000, CRC(439ec031) SHA1(f0ad8f9be7d26bc504593c1321bd23c286a221f0) )

    NEO_SFIX_128K("268pd.s1", CRC(99ef577b) SHA1(82f30b61ea4439a6673e0b70b7a9aceaaafd8943) )
...
ROM_START( mslug4d )
	...
	NEO_SFIX_128K( "263d.s1", CRC(a9446774) SHA1(c5a309fd8ee6d6750a15c82e710218a3755e38b2) )
...
ROM_START( preisl2d )
	...
	NEO_SFIX_128K( "255d.s1", CRC(666cabdc) SHA1(f37206ea84b3053f38b2263c1c228463899e425e) )
...
ROM_START( samsh5bd )
	...
	NEO_BIOS_AUDIO_128K( "270b.m1", CRC(18114fb1) SHA1(016dc2f328340f3637a9bff373a20973df29f6b8) )
...
ROM_START( sams5shnd )
	ROM_REGION( 0x800000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "272shnd.p1", 0x000000, 0x800000, CRC(2dbd32dc) SHA1(595693e1e116f96dbe6e552565a4edb06f685a67) )

	NEO_SFIX_128K( "272d.s1", CRC(c297f973) SHA1(b31af6b51e7536b538cd7eb3542c631c6327e826) )

	NEO_BIOS_AUDIO_128K( "272nd.m1", CRC(0b5d4d6a) SHA1(2467e06be986cba8c879412cba0388019892dbb2) )

	ROM_REGION( 0x1000000, "cslot1:ymsnd:adpcma", 0 )
	ROM_LOAD( "272nd.v1", 0x000000, 0x400000, CRC(4d1b252b) SHA1(e5efe408c337a2ca556e790f0fd917ba44f975e3) )
	ROM_LOAD( "272nd.v2", 0x400000, 0x400000, CRC(0e46d2f8) SHA1(b8b0838124ea29f73f31e08d5cced8797cea75b1) )
	ROM_LOAD( "272nd.v3", 0x800000, 0x400000, CRC(3f0f7554) SHA1(2581e297725f3b950b59e9086ac5569171da6140) )
	ROM_LOAD( "272nd.v4", 0xc00000, 0x400000, CRC(ad8fabb4) SHA1(cebe3b7306e1431ebb99df13bfc2270b1d3ba1ff) )
	// fix sound crackling
	ROM_FILL(0x6bc0,1,0x08)
	ROM_FILL(0xed41,1,0x89)
	ROM_FILL(0x16bc0,1,0x82)
...
ROM_START( sams5sond )
	ROM_REGION( 0x800000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "272sond.p1", 0x000000, 0x800000, CRC(3e3961f5) SHA1(523c117da1df9ea85d29af0efa5884a87a42345e) )
...
ROM_START( svcplusnd )
    ...
    ROM_LOAD16_WORD_SWAP( "269pnd.p1", 0x000000, 0x600000, CRC(1cc8fb7a) SHA1(96fc02803d597c8083a8a25ca1fedb9f50553c8d) )

	NEO_SFIX_128K( "269bp.s1", CRC(aaef740c) SHA1(d7ae898ac93f78b19b125e98659dcfd9ee3179b2) )
...
ROM_START( svcplusand )
	ROM_REGION( 0x2000000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "269pand.p1", 0x000000, 0x600000, CRC(1ee9e340) SHA1(3e9b3c38ecaeaa12f535a8eb5da8c0a02e36152d) )
...
ROM_START( svcsplusnd )
	ROM_REGION( 0x600000, "cslot1:maincpu", ROMREGION_BE|ROMREGION_16BIT )
	ROM_LOAD16_WORD_SWAP( "269spnd.p1", 0x000000, 0x600000, CRC(f6a1df16) SHA1(9d96fcd2996b93823b8c2f7791bcc18e2fc42833) )

	NEO_SFIX_128K( "269spp.s1", CRC(0b6fd62e) SHA1(ebeb80634c91c249412f75c99be93861183d06b9) )
...
GAME( 2004, cthd2k3d,   kof2001,  neo304h,   neogeo,    mvs_led_state, empty_init, ROT0, "bootleg", "Crouching Tiger Hidden Dragon 2003 (The King of Fighters 2001 bootleg, Fully Decrypted / set 1)", MACHINE_SUPPORTS_SAVE )
GAME( 2004, cthd2k3da,  kof2001,  neo304h,   neogeo,    mvs_led_state, empty_init, ROT0, "bootleg", "Crouching Tiger Hidden Dragon 2003 (The King of Fighters 2001 bootleg, Fully Decrypted / set 2)", MACHINE_SUPPORTS_SAVE )
GAME( 2004, cthd2k3a,   kof2001,  cthd2k3a,  neogeo,    mvs_led_state, empty_init, ROT0, "bootleg", "Crouching Tiger Hidden Dragon 2003 (The King of Fighters 2001 bootleg, set 2)", MACHINE_SUPPORTS_SAVE )
GAME( 2004, ct2k3spd,   kof2001,  neo304h,   neogeo,    mvs_led_state, empty_init, ROT0, "bootleg", "Crouching Tiger Hidden Dragon 2003 Super Plus (The King of Fighters 2001 bootleg, Fully Decrypted)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2003, kof97orond, kof97,    neo304h,   neogeo,    mvs_led_state, empty_init, ROT0, "bootleg", "The King of Fighters '97 Chongchu Jianghu Plus 2003 (bootleg) (Fully Decrypted)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2002, kf2k2mpnd,  kof2002,  neo304h,   neogeo,    mvs_led_state, empty_init, ROT0, "bootleg", "The King of Fighters 2002 Magic Plus (bootleg) (Fully Decrypted)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2002, kf2k2mp2nd, kof2002,  neo304h,   neogeo,    mvs_led_state, empty_init, ROT0, "bootleg", "The King of Fighters 2002 Magic Plus II (bootleg) (Fully Decrypted)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2004, kf2k3pd,    kof2003,  neo304h,   neogeo,    mvs_led_state, empty_init, ROT0, "bootleg", "The King of Fighters 2004 Plus / Hero (The King of Fighters 2003 bootleg, Fully Decrypted)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, kf2k3upd,   kof2003,  neo304h,   neogeo,    mvs_led_state, empty_init, ROT0, "bootleg", "The King of Fighters 2004 Ultra Plus (The King of Fighters 2003 bootleg, Fully Decrypted)", MACHINE_SUPPORTS_SAVE )
GAME( 2004, kf2k4pls,   kof2002,  kof2k4pls, neogeo,    mvs_led_state, empty_init, ROT0, "bootleg", "The King of Fighters Special Edition 2004 Plus (The King of Fighters 2002 bootleg)", MACHINE_SUPPORTS_SAVE )
GAME( 2005, kof10thu,   kof2002,  kf10thu,   neogeo,    mvs_led_state, empty_init, ROT0, "bootleg", "The King of Fighters 10th Anniversary 2005 Unique (The King of Fighters 2002 bootleg, set 2)", MACHINE_SUPPORTS_SAVE )
GAME( 2004, lans2k4d,   shocktr2, neo304h,   neogeo,    mvs_led_state, empty_init, ROT0, "bootleg", "Lansquenet 2004 (Shock Troopers - 2nd Squad bootleg / Fully Decrypted)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2003, matrimnd,   matrim,   neo304h,   neogeo,    mvs_led_state, empty_init, ROT0, "Noise Factory / Atlus", "Matrimelee / Shin Gouketsuji Ichizoku Toukon (Fully Decrypted)", MACHINE_SUPPORTS_SAVE )
GAME( 1996, msboot,     mslug,    neo304h,   neogeo,    mvs_led_state, empty_init, ROT0, "Bootleg", "Metal Slug (Bootleg)", MACHINE_SUPPORTS_SAVE )
GAME( 2000, ms3b6boot,  mslug3,   neo304h,   neogeo,    mvs_led_state, empty_init, ROT0, "Bootleg", "Metal Slug 6 (Metal Slug 3 Bootleg) (Decrypted C)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2000, mslug3nd,   mslug3,   neo304h,   neogeo,    mvs_led_state, empty_init, ROT0, "SNK", "Metal Slug 3 (Fully Decrypted)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2003, mslug5b3,   mslug5,   mslug5e,   neogeo,    mvs_led_state, empty_init, ROT0, "Bootleg", "Metal Slug 5 (Bootleg, Set 3)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, mslug5b4,   mslug5,   mslug5e,   neogeo,    mvs_led_state, empty_init, ROT0, "Bootleg", "Metal Slug 5 (Bootleg, Set 4)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, mslug5b5,   mslug5,   neo304h,   neogeo,    mvs_led_state, empty_init, ROT0, "Bootleg", "Metal Slug 5 (Bootleg, Set 5)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, mslug5b6,   mslug5,   neo304h,   neogeo,    mvs_led_state, empty_init, ROT0, "Bootleg", "Metal Slug 5 (Bootleg, Set 6)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, mslug5b7,   mslug5,   mslug5e,   neogeo,    mvs_led_state, empty_init, ROT0, "Bootleg", "Metal Slug 5 (Bootleg, Set 7)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, mslug5b8,   mslug5,   mslug5e,   neogeo,    mvs_led_state, empty_init, ROT0, "Bootleg", "Metal Slug 5 (Bootleg, Set 8)", MACHINE_SUPPORTS_SAVE )
GAME( 1999, mslugxb,    mslugx,   neo304h,   neogeo,    mvs_led_state, empty_init, ROT0, "Bootleg", "Metal Slug X (Bootleg)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2000, pbobblendx, pbobblen, neo304h,   neogeo,    mvs_led_state, empty_init, ROT0, "bootleg", "Puzzle Bobble / Bust-A-Move Deluxe (bootleg)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2003, pnyaand,    pnyaa,    neo304h,   neogeo,    mvs_led_state, empty_init, ROT0, "Aiky", "Pochi and Nyaa (Fully Decrypted)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2004, sams5sond,  samsh5sp, neo304h,   neogeo,    mvs_led_state, empty_init, ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V Special / Samurai Spirits Zero Special (1st release, censored) (Fully decrypted)", MACHINE_SUPPORTS_SAVE )
GAME( 2004, sams5shnd,  samsh5sp, neo304h,   neogeo,    mvs_led_state, empty_init, ROT0, "Yuki Enterprise / SNK Playmore", "Samurai Shodown V Special / Samurai Spirits Zero Special (2nd release, less censored) (Fully decrypted)", MACHINE_SUPPORTS_SAVE )
...
GAME( 2003, svcplusnd,  svc,      neo304h,   neogeo,    mvs_led_state, empty_init, ROT0, "bootleg", "SNK vs. Capcom - SVC Chaos Plus (bootleg, set 1) (Fully Decrypted)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, svcplusand, svc,      neo304h,   neogeo,    mvs_led_state, empty_init, ROT0, "bootleg", "SNK vs. Capcom - SVC Chaos Plus (bootleg, set 2) (Fully Decrypted)", MACHINE_SUPPORTS_SAVE )
GAME( 2003, svcsplusnd, svc,      neo304h,   neogeo,    mvs_led_state, empty_init, ROT0, "bootleg", "SNK vs. Capcom - SVC Chaos Super Plus (bootleg) (Fully Decrypted)", MACHINE_SUPPORTS_SAVE )
GAME( 2001, zupapad,    zupapa,   neo304h,   neogeo,    mvs_led_state, empty_init, ROT0, "SNK", "Zupapa! (Decrypted)", MACHINE_SUPPORTS_SAVE )
GAME( 2001, zupapand,   zupapa,   neo304h,   neogeo,    mvs_led_state, empty_init, ROT0, "SNK", "Zupapa! (Fully decrypted)", MACHINE_SUPPORTS_SAVE )
