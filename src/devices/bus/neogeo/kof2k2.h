...
class neogeo_kof2002d_cart_device : public neogeo_kof2k2type_cart_device
{
public:
...
DECLARE_DEVICE_TYPE(NEOGEO_K2K2_KOF2002D_CART, neogeo_kof2002d_cart_device)

/*************************************************
 kf2k2plsd
 **************************************************/

class neogeo_kf2k2plsd_cart_device : public neogeo_kof2k2type_cart_device
{
public:
...
DECLARE_DEVICE_TYPE(NEOGEO_K2K2_KF2K2PLSD_CART, neogeo_kf2k2plsd_cart_device)

/*************************************************
 kof2k4pls
 **************************************************/

class neogeo_kof2k4pls_cart_device : public neogeo_kof2k2type_cart_device
{
public:
...
DECLARE_DEVICE_TYPE(NEOGEO_K2K2_KOF2K4PLS_CART, neogeo_kof2k4pls_cart_device)

/*************************************************
 matrimd
**************************************************/

class neogeo_matrimd_cart_device : public neogeo_kof2k2type_cart_device
{
public:
...
DECLARE_DEVICE_TYPE(NEOGEO_K2K2_MATRIMD_CART, neogeo_matrimd_cart_device)
...
class neogeo_samsho5d_cart_device : public neogeo_kof2k2type_cart_device
{
public:
...
DECLARE_DEVICE_TYPE(NEOGEO_K2K2_SAMSHO5D_CART, neogeo_samsho5d_cart_device)

/*************************************************
 samsho5spd
**************************************************/

class neogeo_samsho5spd_cart_device : public neogeo_kof2k2type_cart_device
{
public:
...
DECLARE_DEVICE_TYPE(NEOGEO_K2K2_SAMSHO5SPD_CART, neogeo_samsho5spd_cart_device)
