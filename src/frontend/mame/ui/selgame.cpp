...
//============= 设置游戏窗口标题为中文 ======================>>>
			{
				machine().options().set_value("chinesename", system->description, OPTION_PRIORITY_CMDLINE);
...
//缘来是你
//============================================ 获取中文列表 =======================================>>>
				ui_system_info const &sysinfo = m_persistent_data.systems()[driver_list::find(ui_swinfo->driver->name)];
				machine().options().set_value("chinesename", sysinfo.description, OPTION_PRIORITY_CMDLINE);				
//================================================================================================>>>
...
//============================================ 设置中文名称 =========================================>>>
			{
				machine().options().set_value("chinesename", ui_swinfo->longname, OPTION_PRIORITY_CMDLINE);
